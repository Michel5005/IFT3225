  ...
  return (
    <>
      <form method='post'>
          ...
          <button id='create-product' className='btn btn-primary pull-right m-b-15px create-product-button' onClick={e=>handleConnexion(e)}>
...
function App() {
  ...
  useEffect(() => {
    if(read){
      ...
      fetch('http://localhost:3000/product/' + edit, 
      { 
        method: 'GET',
        headers: {
          'authorization': token
